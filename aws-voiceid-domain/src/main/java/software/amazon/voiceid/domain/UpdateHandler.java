    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-VoiceID-Domain::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-VoiceID-Domain::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                    ...
                    proxy.initiate("AWS-VoiceID-Domain::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
